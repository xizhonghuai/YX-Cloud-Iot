...
public class HexUtils {
    ...
    /**
     * int ת byte���飬 2���ֽڻ���4���ֽ� int to byte[], length=2,4
     *
     * @param i
     * @return
     */
    ...
    /**
     * intתbyte���飬3���ֽ� int to byte[], length=3
     *
     * @param i
     * @return
     */
    ...
    /**
     * int ת���飬�з��ţ����ֽ� int to byte[], contain sign
     *
     * @param signIntVal
     * @return
     */
